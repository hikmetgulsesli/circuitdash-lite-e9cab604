...
- CircuitDash Lite turns the user's request into a directly usable game workflow. The first experience must be the actual browser game behavior, not a marketing landing page or placeholder demo.
- - FR-001: Build a compact browser-game called CircuitDash Lite. It should be a full-viewport timing arcade game where the player guides a pulsing signal through rotating circuit gates, avoids overload zones, scores completed circuits, and can open an in-game settings screen for speed, difficulty, audio, pause/resume,…
...
- Gameplay - CircuitDash Lite
- Game Settings - CircuitDash Lite

## SCREEN_SPECS
SCREEN_SPEC_1:
- exact_screen_title: Gameplay - CircuitDash Lite
...
SCREEN_SPEC_2:
- exact_screen_title: Game Settings - CircuitDash Lite
